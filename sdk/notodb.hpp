...
public:
    ...
    using Data = std::variant<std::vector<std::uint8_t>, std::error_code>;

    static Data data(JSContext *, std::filesystem::path);
    static Data data(JSContext *, std::filesystem::path, std::variant_alternative_t<0, Data> &&);
